...
When we enable the API for your user, access our platform, and in the menu with your name click on "Configurações" (Security), and in the "API" section generate a token.
